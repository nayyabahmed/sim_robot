...
if("TRUE" STREQUAL "TRUE")
  set(mobot_urdf_SOURCE_PREFIX /home/nayab/project_ws/src/mobot_urdf)
  set(mobot_urdf_DEVEL_PREFIX /home/nayab/project_ws/devel)
  ...
  set(mobot_urdf_INSTALL_PREFIX /home/nayab/project_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nayab/project_ws/src/mobot_urdf/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mobot_urdf_EXPORTED_TARGETS ${${mobot_urdf_dep}_EXPORTED_TARGETS})
endforeach()
